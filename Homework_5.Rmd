...
### Proportions of unsolved homocides and total number of homosides in Baltimore, MD
```{r}
...
### Proportions of unsolved homocides and total number of homosides in all cities 
```{r}
